...
//	(and yes, I know about stdbool.h but I like capitals for these and I'm
//old)
...
extern int wiringPiSetupPiFaceForGpioProg(
    void);  // Don't use this - for gpio program only
